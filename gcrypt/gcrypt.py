...
gcry_strerror = _gcrypt_lib.gcry_strerror
gcry_strerror.argtypes = [c_uint]
gcry_strerror.restype = c_char_p

# /* Return a pointer to a string containing a description of the error
#    source in the error value ERR.  */
# const char *gcry_strsource (gcry_error_t err);
gcry_strsource = _gcrypt_lib.gcry_strsource
gcry_strsource.argtypes = [c_uint]
gcry_strsource.restype = c_char_p

# /* Retrieve the error code for the system error ERR.  This returns
#    GPG_ERR_UNKNOWN_ERRNO if the system error is not mapped (report
#    this).  */
# gcry_err_code_t gcry_err_code_from_errno (int err);
gcry_err_code_from_errno = _gcrypt_lib.gcry_err_code_from_errno
gcry_err_code_from_errno.argtypes = [c_int]
gcry_err_code_from_errno.restype = c_uint

# /* Retrieve the system error for the error code CODE.  This returns 0
#    if CODE is not a system error code.  */
# int gcry_err_code_to_errno (gcry_err_code_t code);
gcry_err_code_to_errno = _gcrypt_lib.gcry_err_code_to_errno
gcry_err_code_to_errno.argtypes = [c_uint]
gcry_err_code_to_errno.restype = c_int

# /* Return an error value with the error source SOURCE and the system
#    error ERR.  */
# gcry_error_t gcry_err_make_from_errno (gcry_err_source_t source, int err);
gcry_err_make_from_errno = _gcrypt_lib.gcry_err_make_from_errno
gcry_err_make_from_errno.argtypes = [c_uint, c_int]
gcry_err_make_from_errno.restype = c_uint

# /* Return an error value with the system error ERR.  */
# gcry_err_code_t gcry_error_from_errno (int err);
gcry_error_from_errno = _gcrypt_lib.gcry_error_from_errno
gcry_error_from_errno.argtypes = [c_int]
gcry_error_from_errno.restype = c_uint
...
#             ]
# # } _GCRY_ATTR_INTERNAL;
# _GCRY_ATTR_INTERNAL = gcry_thread_cbs()
#
...
#    functions.  */
# struct gcry_sexp;
class gcry_sexp(Structure): pass
...
#                             int autodetect);
gcry_sexp_new = _gcrypt_lib.gcry_sexp_new
gcry_sexp_new.argtypes = [POINTER(gcry_sexp_t), c_void_p, c_size_t, c_int]
...
gcry_sexp_create = _gcrypt_lib.gcry_sexp_create
gcry_sexp_create.argtypes = [POINTER(gcry_sexp_t), c_void_p, c_size_t, c_int,
                             CFUNCTYPE(None)]
...
gcry_sexp_sscan = _gcrypt_lib.gcry_sexp_sscan
gcry_sexp_sscan.argtypes = [POINTER(gcry_sexp_t), POINTER(c_size_t),
                            c_char_p, c_size_t]
...
#                               const char *format, ...);
gcry_sexp_build = _gcrypt_lib.gcry_sexp_build
# gcry_sexp_build.argtypes = [POINTER(gcry_sexp_t), POINTER(c_size_t),
#                             c_char_p]
...
gcry_sexp_build_array = _gcrypt_lib.gcry_sexp_build_array
gcry_sexp_build_array.argtypes = [POINTER(gcry_sexp_t), POINTER(c_size_t),
                                  c_char_p, POINTER(c_void_p)]
gcry_sexp_build_array.restype = gcry_error_t

# /* Release the S-expression object SEXP */
# void gcry_sexp_release (gcry_sexp_t sexp);
gcry_sexp_release = _gcrypt_lib.gcry_sexp_release
...
gcry_sexp_canon_len = _gcrypt_lib.gcry_sexp_canon_len
gcry_sexp_canon_len.argtypes = [POINTER(c_ubyte), c_size_t,
                                POINTER(c_size_t), POINTER(gcry_error_t)]
gcry_sexp_canon_len.restype = c_size_t

# /* Copies the S-expression object SEXP into BUFFER using the format
#    specified in MODE.  */
# size_t gcry_sexp_sprint (gcry_sexp_t sexp, int mode, void *buffer,
#                          size_t maxlength);
gcry_sexp_sprint = _gcrypt_lib.gcry_sexp_sprint
gcry_sexp_sprint.argtypes = [gcry_sexp_t, c_int, c_void_p, c_size_t]
gcry_sexp_sprint.restype = c_size_t

# /* Dumps the S-expression object A in a format suitable for debugging
#    to Libgcrypt's logging stream.  */
# void gcry_sexp_dump (const gcry_sexp_t a);
gcry_sexp_dump = _gcrypt_lib.gcry_sexp_dump
gcry_sexp_dump.argtypes = [gcry_sexp_t]
gcry_sexp_dump.restype = None

# gcry_sexp_t gcry_sexp_cons (const gcry_sexp_t a, const gcry_sexp_t b);
gcry_sexp_cons = _gcrypt_lib.gcry_sexp_cons
gcry_sexp_cons.argtypes = [gcry_sexp_t, gcry_sexp_t]
gcry_sexp_cons.restype = gcry_sexp_t

# gcry_sexp_t gcry_sexp_alist (const gcry_sexp_t *array);
gcry_sexp_alist = _gcrypt_lib.gcry_sexp_alist
gcry_sexp_alist.argtypes = [POINTER(gcry_sexp_t)]
gcry_sexp_alist.restype = gcry_sexp_t

# gcry_sexp_t gcry_sexp_vlist (const gcry_sexp_t a, ...);
gcry_sexp_vlist = _gcrypt_lib.gcry_sexp_vlist

# gcry_sexp_t gcry_sexp_append (const gcry_sexp_t a, const gcry_sexp_t n);
gcry_sexp_append = _gcrypt_lib.gcry_sexp_append
gcry_sexp_append.argtypes = [gcry_sexp_t, gcry_sexp_t]
gcry_sexp_append.restype = gcry_sexp_t

# gcry_sexp_t gcry_sexp_prepend (const gcry_sexp_t a, const gcry_sexp_t n);
gcry_sexp_prepend = _gcrypt_lib.gcry_sexp_prepend
...
gcry_sexp_find_token = _gcrypt_lib.gcry_sexp_find_token
gcry_sexp_find_token.argtypes = [gcry_sexp_t, c_char_p, c_size_t]
gcry_sexp_find_token.restype = gcry_sexp_t

# /* Return the length of the LIST.  For a valid S-expression this
#    should be at least 1.  */
# int gcry_sexp_length (const gcry_sexp_t list);
gcry_sexp_length = _gcrypt_lib.gcry_sexp_length
...
gcry_sexp_nth = _gcrypt_lib.gcry_sexp_nth
...
gcry_sexp_car = _gcrypt_lib.gcry_sexp_car
...
gcry_sexp_cdr = _gcrypt_lib.gcry_sexp_cdr
gcry_sexp_cdr.argtypes = [gcry_sexp_t]
gcry_sexp_cdr.restype = gcry_sexp_t

# gcry_sexp_t gcry_sexp_cadr (const gcry_sexp_t list);
gcry_sexp_cadr = _gcrypt_lib.gcry_sexp_cadr
...
#                                 size_t *datalen);
gcry_sexp_nth_data = _gcrypt_lib.gcry_sexp_nth_data
gcry_sexp_nth_data.argtypes = [gcry_sexp_t, c_int, POINTER(c_size_t)]
gcry_sexp_nth_data.restype = c_char_p
...
#                             size_t *rlength);
gcry_sexp_nth_buffer = _gcrypt_lib.gcry_sexp_nth_buffer
gcry_sexp_nth_buffer.argtypes = [gcry_sexp_t, c_int, POINTER(c_size_t)]
gcry_sexp_nth_buffer.restype = c_void_p
...
gcry_sexp_nth_string = _gcrypt_lib.gcry_sexp_nth_string
gcry_sexp_nth_string.argtypes = [gcry_sexp_t, c_int]
gcry_sexp_nth_string.restype = c_char_p
...
gcry_sexp_nth_mpi = _gcrypt_lib.gcry_sexp_nth_mpi
...
gcry_sexp_extract_param = _gcrypt_lib.gcry_sexp_extract_param
...
gcry_mpi_format = c_uint
GCRYMPI_FMT_NONE= 0
#/* Twos complement stored without length.  */
GCRYMPI_FMT_STD = 1
#/* As used by OpenPGP (unsigned only).  */
GCRYMPI_FMT_PGP = 2
#/* As used by SSH (like STD but with length).  */
GCRYMPI_FMT_SSH = 3
#/* Hex format. */
GCRYMPI_FMT_HEX = 4
#/* Like STD but unsigned. */
GCRYMPI_FMT_USG = 5
#/* Opaque format (some functions only).  */
GCRYMPI_FMT_OPAQUE = 8

# /* Flags used for creating big integers.  */
# enum gcry_mpi_flag
gcry_mpi_flag = c_uint
...
gcry_mpi_snatch = _gcrypt_lib.gcry_mpi_snatch
gcry_mpi_snatch.argtypes = [gcry_mpi_t, gcry_mpi_t]
gcry_mpi_snatch.restype = None

# /* Store the big integer value U in W. */
# gcry_mpi_t gcry_mpi_set (gcry_mpi_t w, const gcry_mpi_t u);
gcry_mpi_set = _gcrypt_lib.gcry_mpi_set
gcry_mpi_set.argtypes = [gcry_mpi_t, gcry_mpi_t]
gcry_mpi_set.restype = gcry_mpi_t

# /* Store the unsigned integer value U in W. */
# gcry_mpi_t gcry_mpi_set_ui (gcry_mpi_t w, unsigned long u);
gcry_mpi_set_ui = _gcrypt_lib.gcry_mpi_set_ui
gcry_mpi_set_ui.argtypes = [gcry_mpi_t, c_ulong]
gcry_mpi_set_ui.restype = gcry_mpi_t

# /* Swap the values of A and B. */
# void gcry_mpi_swap (gcry_mpi_t a, gcry_mpi_t b);
gcry_mpi_swap = _gcrypt_lib.gcry_mpi_swap
...
gcry_mpi_is_neg = _gcrypt_lib.gcry_mpi_is_neg
gcry_mpi_is_neg.argtypes = [gcry_mpi_t]
gcry_mpi_is_neg.restype = c_int

# /* W = - U */
# void gcry_mpi_neg (gcry_mpi_t w, gcry_mpi_t u);
gcry_mpi_neg = _gcrypt_lib.gcry_mpi_neg
gcry_mpi_neg.argtypes = [gcry_mpi_t, gcry_mpi_t]
gcry_mpi_neg.restype = None

# /* W = [W] */
# void gcry_mpi_abs (gcry_mpi_t w);
gcry_mpi_abs = _gcrypt_lib.gcry_mpi_abs
gcry_mpi_abs.argtypes = [gcry_mpi_t]
gcry_mpi_abs.restype = None
...
gcry_pk_encrypt = _gcrypt_lib.gcry_pk_encrypt
...
gcry_pk_decrypt = _gcrypt_lib.gcry_pk_decrypt
...
#                            gcry_sexp_t data, gcry_sexp_t skey);
gcry_pk_sign = _gcrypt_lib.gcry_pk_sign
...
gcry_pk_genkey = _gcrypt_lib.gcry_pk_genkey
gcry_pk_genkey.argtypes = [POINTER(gcry_sexp_t), gcry_sexp_t]
gcry_pk_genkey.restype = gcry_error_t

# /* Catch all function for miscellaneous operations. */
# gcry_error_t gcry_pk_ctl (int cmd, void *buffer, size_t buflen);
gcry_pk_ctl = _gcrypt_lib.gcry_pk_ctl
gcry_pk_ctl.argtypes = [c_int, c_void_p, c_size_t]
gcry_pk_ctl.restype = gcry_error_t

# /* Retrieve information about the public key algorithm ALGO. */
# gcry_error_t gcry_pk_algo_info (int algo, int what,
#                                 void *buffer, size_t *nbytes);
gcry_pk_algo_info = _gcrypt_lib.gcry_pk_algo_info
gcry_pk_algo_info.argtypes = [c_int, c_int, c_void_p, POINTER(c_size_t)]
...
gcry_pk_algo_name = _gcrypt_lib.gcry_pk_algo_name
gcry_pk_algo_name.argtypes = [c_int]
gcry_pk_algo_name.restype = c_char_p

# /* Map the algorithm NAME to a public key algorithm Id.  Return 0 if
#    the algorithm name is not known. */
# int gcry_pk_map_name (const char* name) _GCRY_GCC_ATTR_PURE;
gcry_pk_map_name = _gcrypt_lib.gcry_pk_map_name
gcry_pk_map_name.argtypes = [c_char_p]
gcry_pk_map_name.restype = c_int

# /* Return what is commonly referred as the key length for the given
#    public or private KEY.  */
# unsigned int gcry_pk_get_nbits (gcry_sexp_t key) _GCRY_GCC_ATTR_PURE;
gcry_pk_get_nbits = _gcrypt_lib.gcry_pk_get_nbits
...
gcry_pk_get_keygrip = _gcrypt_lib.gcry_pk_get_keygrip
...
gcry_pk_get_curve = _gcrypt_lib.gcry_pk_get_curve
gcry_pk_get_curve.argtypes = [gcry_sexp_t, c_int, POINTER(c_uint)]
gcry_pk_get_curve.restype = c_char_p
...
gcry_pk_get_param = _gcrypt_lib.gcry_pk_get_param
gcry_pk_get_param.argtypes = [c_int, c_char_p]
gcry_pk_get_param.restype = gcry_sexp_t

# /* Return 0 if the public key algorithm A is available for use. */
# #define gcry_pk_test_algo(a) \
#             gcry_pk_algo_info( (a), GCRYCTL_TEST_ALGO, NULL, NULL )
gcry_pk_test_algo = lambda a: gcry_pk_algo_info(a, GCRYCTL_TEST_ALGO, None,
                                                None)
...
gcry_pubkey_get_sexp = _gcrypt_lib.gcry_pubkey_get_sexp
gcry_pubkey_get_sexp.argtypes = [POINTER(gcry_sexp_t), c_int, gcry_ctx_t]
gcry_pubkey_get_sexp.restype = gcry_error_t
...
gcry_mac_reset = lambda h: gcry_mac_ctl(h, GCRYCTL_RESET, None, 0)

# /* Return 0 if the algorithm A is available for use. */
#define gcry_mac_test_algo(a) \
            # gcry_mac_algo_info( (a), GCRYCTL_TEST_ALGO, NULL, NULL )
gcry_mac_test_algo = lambda a: gcry_mac_algo_info(a, GCRYCTL_TEST_ALGO, None,
                                                  None)
...
#                                     int quality);
gcry_random_add_bytes = _gcrypt_lib.gcry_random_add_bytes
gcry_random_add_bytes.argtypes = [c_void_p, c_size_t, c_int]
...
gcry_fast_random_poll = lambda: gcry_control(GCRYCTL_FAST_POLL, None)
...
gcry_mpi_randomize = _gcrypt_lib.gcry_mpi_randomize
gcry_mpi_randomize.argtypes = [gcry_mpi_t, c_uint, c_uint]
...
#                                   unsigned int flags);
gcry_prime_generate = _gcrypt_lib.gcry_prime_generate
gcry_prime_generate.argtypes = [POINTER(gcry_mpi_t), c_uint, c_uint,
                                POINTER(POINTER(gcry_mpi_t)),
                                gcry_prime_check_func_t, c_void_p,
                                gcry_random_level_t, c_uint]
...
#                                          gcry_mpi_t *factors,
#                                          gcry_mpi_t start_g);
gcry_prime_group_generator = _gcrypt_lib.gcry_prime_group_generator
gcry_prime_group_generator.argtypes = [POINTER(gcry_mpi_t), gcry_mpi_t,
                                       POINTER(gcry_mpi_t), gcry_mpi_t]
gcry_prime_group_generator.restype = gcry_error_t


# /* Convenience function to release the FACTORS array. */
# void gcry_prime_release_factors (gcry_mpi_t *factors);
gcry_prime_release_factors = _gcrypt_lib.gcry_prime_release_factors
...
gcry_prime_check = _gcrypt_lib.gcry_prime_check
...
gcry_is_secure = _gcrypt_lib.gcry_is_secure
gcry_is_secure.argtypes = [c_void_p]
gcry_is_secure.restype = c_int

# /* Return true if Libgcrypt is in FIPS mode.  */
#define gcry_fips_mode_active()  !!gcry_control (GCRYCTL_FIPS_MODE_P, 0)
gcry_fips_mode_active = lambda: gcry_control(GCRYCTL_FIPS_MODE_P, 0)
